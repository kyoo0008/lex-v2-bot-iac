locals {
  ...
  prompt_model_id = "us.amazon.nova-lite-v1:0"
  ...
  # deployment_config = var.env == "prod" ? jsondecode(file("${path.module}/deployment_vars.json")) : {}
  wisdom_assistant_prefix = "${local.naming_prefix}-qconnect-assistant"
