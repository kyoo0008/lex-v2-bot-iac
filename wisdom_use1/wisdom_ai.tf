...
# -------------------------------------------------------------------------------------------------
# // Amazon Connect Lambda -> AICC IaC에서 data.aws_lambda_function 바꾸기 
# -------------------------------------------------------------------------------------------------

resource "aws_connect_lambda_function_association" "lmd_assoication" {
  function_arn = data.aws_lambda_function.qic_create_session.arn
  instance_id = data.aws_connect_instance.connect_instance.id
}

resource "aws_connect_lambda_function_association" "lmd_qic_apigateway_caller_assoication" {
  function_arn = data.aws_lambda_function.qic_apigateway_caller.arn
  instance_id = data.aws_connect_instance.connect_instance.id
}
